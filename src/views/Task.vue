        ...
        <div class="flex-1 p-4 bg-gray-100 flex items-center justify-center">
            <div class="w-3/4">
                ...
                <div class="mb-4 flex items-center">
                    <label class="block font-semibold text-gray-800 mb-2 mr-4">门票:</label>
...
import { SeatPlan, Audiences, CurShowData, GetUserAudiencesResult, GetSeatPlansResult, Show, Session, BuyTicketParam } from '../types';
...
const submit = async () => {
    if (show.value.backendCategory.name != 'YanChangHui') {
        toast.success(`演出类型:${show.value.backendCategory.displayName}暂不支持, 目前仅支持演唱会!`);
        return
    }
